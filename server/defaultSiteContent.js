export const defaultSiteContent = {
  home: {
    heroEyebrow: 'Trusted MICE Operations Partner',
    ...
    processSteps: [
      {
        step: '01',
        title: '요구사항 정리',
        description: '행사 목적, 대상, 일정, 운영 범위를 먼저 정리해 어떤 방식이 맞는지 빠르게 잡습니다.',
      },
      {
        step: '02',
        title: '제안 및 구축',
        description: '운영 흐름, 홈페이지, 안내 자료, 협업 방식까지 실제 실행 단위로 설계합니다.',
      },
      {
        step: '03',
        title: '운영 및 사후 정리',
        description: '행사 당일 운영과 종료 후 결과 정리까지 끊기지 않도록 마무리합니다.',
      },
    ],
